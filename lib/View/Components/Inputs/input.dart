...
class Input extends StatefulWidget {
  ...
  double leftPadding;
  Input({this.lable,this.width=maxItemWidth,this.height=50,this.hint,this.initValue,this.onChange,this.isNumber=false,this.icon1,this.icon2,this.lines=1,this.align=TextAlign.right,this.hasBorder=true,this.hintFontType=fontTypes.bodySM,this.leftPadding=0});
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          contentPadding: EdgeInsets.only(left: widget.leftPadding,right: 15),
          filled: true,
          fillColor: dominantColorShade100.withOpacity(0.7),
          ...
          errorBorder: widget.hasBorder? OutlineInputBorder(
            borderSide: BorderSide(color: dominantColorShade100.withOpacity(0.3),width: borderSize),
          ...
          hintStyle: AppController.fontStyle(fontTypes.bodySM, additionalColor2Shade800),
